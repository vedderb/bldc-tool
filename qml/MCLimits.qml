                    ...
                    Rectangle{
                        ...
                        Grid{
                            ...
                            TextField{
                                id:textFieldMinDC
                                width: rectGridOther.width*0.25
                                text: Math.round(  mcconf.l_min_duty * 1000) / 1000
                            }
                            Text{
                                id:textMaxDC
                            ...
                            TextField{
                                id:textFieldMaxDC
                                width: rectGridOther.width*0.25
                                text: Math.round(  mcconf.l_max_duty * 1000) / 1000
                            }
                        }
                    }
                }
                    ...
                    Rectangle{
                        ...
                        Grid{
                            ...
                            TextField{
                                ...
                                text: Math.round(  mcconf.cc_startup_boost_duty * 1000) / 1000
                            }
                            Text{
                                id:textMinCurrent
                                text: "Min current"
                            ...
                            TextField{
                                ...
                                width: rectGridCurrControl.width*0.25
                                text: Math.round(  mcconf.cc_gain * 100000) / 100000
                            }
                        }
                    }
                }
